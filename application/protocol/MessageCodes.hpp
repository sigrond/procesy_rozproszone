 ...
 *
 * \file     MessageCodes.hpp
 *
 * \brief    Plik nagłówkowy z typami wyliczeniowymi kodów
 *
...
{
	/**
	 * \brief Kody kategorii komunikatów
	 */
	enum class Category 
	{
	...
	/**
	 * \brief Kody podkategorii komunikatów HOST
	 */
	enum class HostSub
	{
	...
	/**
	 * \brief Kody podkategorii komunikatów TASK
	 */
	enum class TaskSub
	{
	...
	/**
	 * \brief Kody podkategorii komunikatów ERR
	 */
	enum class ErrSub
	{
