// I don't take my duties seriously
...
int roll()
{
        ...
        std::mt19937 mt(rd());
        std::uniform_int_distribution<int> distribution(0, sizeof(pasta)/sizeof(pasta[0]) );
