    ...
    \section{Protokół LOTC}
        ...
        \subsubsection{Szczegóły protokołu}
            ...
            \begin{tabular}{ c | c | c }
			    ...
			    ... &  &  \\
			    Adres n & 32(IPv4)/128(IPv6) & Adres IP n-tego agenta, gdzie n to wartość pola \say"Liczba agentów" \\
			\end{tabular}
            ...
            \begin{tabular}{ c | c | c }
			    ...
			    \hline
			    Kod komunikatu & 8 & \\
			    Flaga typu pliku & 1 & 0 - główny plik wykonywalny zadania, 1 - plik pomocniczy \\
