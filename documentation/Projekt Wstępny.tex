...
\begin{document}
	    ...
	    \subsection{Struktura protokołu}
			...
			\subsubsection{Podkategorie}
		        ...
		        \begin{tabular}{ c | c | c | c }
				    ...
				    \hline
				    000 & 0 & ADD & Dodanie zadania \\
				    001 & 1 & RM & Usunięcie zadania \\
				    010 & 2 & RUN & Wykonanie zadania \\
				    011 & 3 & KILL & Zakończenie zadania \\
				    100 & 4 & STOP & Wstrzymanie zadania \\
				    101 & 5 & CONT & Kontynuowanie zadania \\
				    110 & 6 & x & [zabroniony] \\
				    111 & 7 & x & [zabroniony] \\
				\end{tabular}
		        ...
		        \begin{tabular}{ c | c | c | c }
				    \textbf{Kod binarnie} & \textbf{Kod dziesiątkowo} & \textbf{Podkategoria} & \textbf{Opis} \\
				    \hline
				    000 & 0 & HEAD & Błędny nagłówek \\
				    001 & 1 & LGTH & Błędna długość \\
				    010 & 2 & CSUM & Błędna suma kontrolna \\
				    011 & 3 & x & [zabroniony] \\
				    100 & 4 & x & [zabroniony] \\
				    101 & 5 & x & [zabroniony] \\
				    110 & 6 & x & [zabroniony] \\
    ...
    \section{Konsola administratora}
		...
		\subsection{Komendy}
			...
			\begin{itemize}   
				\item Dodanie/usunięcie zadania
				\item Nadanie priorytetu zadania (przy dodawaniu)
				\item Definiowanie kolejności następowania zadań (przy dodawaniu)
